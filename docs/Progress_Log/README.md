...
## 📅 날짜별 로그
- [2026-04-20.md](./2026-04-20.md) - `SwordSlashSpawner`의 velocity-only slash spawn 조건을 `AttackState` 게이트로 보강해 이동 입력 중 sword VFX 오탐을 차단, 비공격 구간 `_lastPosition` reset으로 진입 스파이크를 방지, 빌드 검증 및 문서 동기화
